...
//        printArray(arr);
        System.out.println("Run time for Insertion is:  " + insertionTotalTime);
        System.out.println();
        System.out.println();

        //****time and print selection sort*****
...
//        printArray(arr);
        System.out.println("Run time Selection is:  " + selectionTotalTime);
        System.out.println();
        System.out.println();


        //****time and print shell sort****
...
//        System.out.println();
        ...
        long shellTotalTime = ShellEndTime - shellStartTime;

//        System.out.println("Array after Shell Sort");
//        printArray(arr);
        System.out.println("Run time for Shell Sort is:  " + shellTotalTime);
        System.out.println();
        System.out.println();
